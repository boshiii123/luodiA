...
let app = {}
app.data = {}
app.gateway = 'https://events.podvall.com/events/subscribe' //change to your eventsapp url
app.data.channel = 'DaPS' //Channel
app.data.subid = 'EN_tit_psh' //SubID
app.data.publisher='9s15q832RAHykukxoZufXQQwGh1AouSJX8CDnwxWmejbkHzwR4WvlkDbSvoc5npN' //PublisherAPI
