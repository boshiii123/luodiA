            ...
            return e.prototype.getToken = function(e, t, n) {
                return o(this, void 0, void 0, function() {
                    ...
                    return s(this, function(s) {
                        switch (s.label) {
                            case 0:
                                r = w(t.getKey("p256dh")), i = w(t.getKey("auth")), o = "authorized_entity=" + e + "&endpoint=" + t.endpoint + "&encryption_key=" + r + "&encryption_auth=" + i, n !== T && (a = w(n), o += "&application_pub_key=" + a), (c = new Headers).append("Content-Type", "application/x-www-form-urlencoded"), u = {
                                    method: "POST",
                                    headers: c,
                                    body: o
                                }, s.label = 1;
                ...
                return o(this, void 0, void 0, function() {
                    ...
                    return s(this, function(s) {
                        switch (s.label) {
                            case 0:
                                o = w(r.getKey("p256dh")), a = w(r.getKey("auth")), c = "push_set=" + n + "&token=" + t + "&authorized_entity=" + e + "&endpoint=" + r.endpoint + "&encryption_key=" + o + "&encryption_auth=" + a, i !== T && (u = w(i), c += "&application_pub_key=" + u), (h = new Headers).append("Content-Type", "application/x-www-form-urlencoded"), f = {
                                    method: "POST",
                                    headers: h,
                                    body: c
                                }, s.label = 1;
